...
/**
 * A simple JWT decoder. This just splits the base 64 encoded string into 2 or 3 parts (depending on
 * existing signature part) and does a base 64 decoding on the first two parts. There is no check of
 * the signature included (which is a must have in productive code)
 */
